        ...
        >
          <Grid item xs={12} sm={6} md={4} lg={3} mb={5} mt={5} className="footer-size">
            ...
            >
              ...
              >
                <MailOutlineIcon />
                <a href="https://top.mail.ru/visits?id=3268894&from=jumpfrom" target="_blank">info@tenders.kg</a>
              </div>
          ...
          <Grid item xs={12} sm={6} md={4} lg={3} mb={5} mt={7} className="footer-size">
            ...
            <div style={{ marginTop: "20px"}}>
              <Typography variant="subtitle1" mb={5} gutterBottom>
                ...
                доступна{" "}
                <a href="https://www.youtube.com/watch?v=5ubUM_K27MI" target="_blank" style={{ color: "#44ace9" }}>
                  здесь
                </a>
              </Typography>
          ...
          <Grid item xs={12} sm={6} md={4} lg={3} mb={5} mt={7} className="footer-size">
            ...
            <div style={{ marginTop: "20px" }}>
              <RouterLink to='/support' style={{ textDecoration: "none", color: "inherit" }}>
                <Typography mb={4} variant="subtitle1" gutterBottom>
                  Служба поддержки
                </Typography>
              </RouterLink>
